...
var Creative = {
  ...
  startAd: function () {
    ...
    if (adSizeMeta) {
      var [width, height] = adSizeMeta.content
        .split(",")
        .map((size) => size.replace(/(width=|height=)/, "").trim());
  ...
  onThumbDrag: function (event) {
    ...
    const onDragMove = (e) => {
      ...
      const newThumbTop = Math.min(
        Math.max(initialThumbTop + deltaY, 0),
        customScrollbar.clientHeight - scrollThumb.clientHeight
      );
      const scrollRatio =
        newThumbTop / (customScrollbar.clientHeight - scrollThumb.clientHeight);
      scrollContent.scrollTop =
        scrollRatio * (scrollContent.scrollHeight - scrollContent.clientHeight);
    };
  ...
  init: function () {
    ...
    if (h1HollowTxt === "") {
      Creative.tl
        ...
        .set("#main", { backgroundColor: bgColor[8] }, "frame1");
    } else {
      Creative.tl
        .addLabel("frame1")
        .to("#heading1", { autoAlpha: 1 }, "frame1+=0.05")
        .set("#main", { backgroundColor: bgColor[8] }, "frame1-=0.1");
    }
    Creative.tl
      .to(["#h1HollowTxt .splitted-container"], 0.001, { alpha: 1 }, "frame1")
      .from("#h1HollowTxt", 0.8, { y: 25, ease: "expo.out" }, "frame1+=0.1")
      .from(
        "#h1Heading .splitted-container",
        0.8,
        { y: 200, stagger: 0.1, ease: "expo.out" },
        "frame1"
      )
      .to(
        "#h1Heading .splitted-container",
      ...
      .from(
        "#h1PenCircL, #h1PenLineL",
        0.45,
        { x: -210, ease: "power3.out" },
        "frame1+=0.45"
      )
      .from(
        "#h1PenCircR, #h1PenLineR",
        0.45,
        { x: 210, ease: "power3.out" },
        "frame1+=0.45"
      )
      ...
      // -------- F1 OUT --------
      .addLabel("frame1_end") // Optional tag to mark the end of the frame
      .to({}, 0.8, {}, "frame1_end") // Add a 0.5 second pause
      .addLabel("outFrame1")
      .to(
        "#heading1 ",
        0.2,
        { x: -150, alpha: 0, ease: "power1.in" },
        "outFrame1"
      )
      ...
      .addLabel("frame2")
      .to("#heading2", { autoAlpha: 1 }, "frame6")
      .set("#main", { backgroundColor: bgColor[5] }, "frame2")
      .set("#h2HollowTxt", { x: 0 }, "frame2")
      .set("#h2HollowTxt_2", { x: 0 }, "frame2")
      .from("#heading2", 0.5, { x: 65, ease: "power2.out" }, "frame2")
      .from(
        ["#h2HollowTxt .splitted-container"],
        0.01,
        { alpha: 0, ease: "power2.out" },
        "frame2"
      )
      .from(
        ["#h2HollowTxt_2 .splitted-container"],
        0.01,
        { alpha: 0, ease: "power2.out" },
        "frame2"
      )

      // Move the number up (#h2HollowTxt)
      .to("#h2HollowTxt", 2, { x: -20, ease: "power0.inOut" }, "frame2+=0.2")

      // Move the number down (#h2HollowTxt_2)
      .to("#h2HollowTxt_2", 2, { x: -20, ease: "power0.inOut" }, "frame2+=0.2")
      ...
      .from(
        "#heading3",
        1.5,
        { scale: 1.56, y:-15, z: 0.001, ease: "sine.out" },
        "frame3"
      )
      .from("#h2BigCirc", 0.01, { autoAlpha: 0 }, "frame3")
      .to("#heading3", { autoAlpha: 1 }, "frame3")
      .to("#heading2", { autoAlpha: 0 }, "frame3")
      .to("#main", { backgroundColor: bgColor[2] }, "frame3")

      // -------- F3 OUT --------
      .addLabel("outFrame3")
      .to("#h3Heading", 0.8, { y: -200, ease: "power4.in" }, "outFrame3")
      .to("#h3SubHead", 0.8, { y: -200, ease: "power4.in" }, "outFrame3")
      .to(
        ".f3Circ",
        0.4,
        { scale: 3.5, z: 0.001, ease: "power1.out" },
        "outFrame3+=0.66"
      )
    ...
    if (h4HollowTxt === "") {
      ...
      Creative.tl
        ...
        .set("#main", { backgroundColor: bgColor[3] }, "frame4-=0.1");
    }
    Creative.tl
      .to(["#h4HollowTxt .splitted-container"], 0.001, { alpha: 1 }, "frame4")
      .from("#h4HollowTxt", 0.8, { y: 25, ease: "expo.out" }, "frame4+=0.1")
      .from(
        "#h4Heading .splitted-container",
        0.8,
        { y: 200, stagger: 0.1, ease: "expo.out" },
        "frame4"
      )
      ...
      .from(
        "#h4PenCircL, #h4PenLineL",
        0.45,
        { x: -210, ease: "power3.out" },
        "frame4+=0.45"
      )
      .from(
        "#h4PenCircR, #h4PenLineR",
        0.45,
        { x: 210, ease: "power3.out" },
        "frame4+=0.45"
      )
      ...
      .to(
        "#heading4 ",
        0.5,
        { y: -150, alpha: 0, ease: "power4.in" },
        "outFrame4+=0.1" // Add a small delay
      )
      ...
      .to("#main", { backgroundColor: bgColor[8] }, "frame5")

      .from(
        "#h5Heading .splitted-container",
        0.8,
        { y: 200, stagger: 0.1, ease: "expo.out" },
        "frame5-=0.2"
      )
      ...
      // move the block (txt) down
      .to(
        "#heading5",
        0.3,
        { y: "+=2", ease: "power1.out" },
        "frame5" // starts with frame5
      )
