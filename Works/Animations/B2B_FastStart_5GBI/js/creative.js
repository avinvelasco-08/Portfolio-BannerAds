...
var Creative = {
    ...
    init: function() {
        ...
        Creative.splitLines(["h1Heading","h4Heading","","h1HollowTxtOut","h1HollowTxtIn","h6HollowTxt","h6Heading","h7Heading","h8Heading","h8HollowTxtOut","h8HollowTxtIn","h9Heading"]);
//        alert(bgColor[0])
        ...
        .to("#circRotate, #h5Heading2", {autoAlpha:0}, "reset")
        .set([splittedLines[0], splittedLines[1], splittedWords[0], splittedLines[2], splittedLines[8], splittedLines[11]], {alpha:0})
        ...
        .set("#h4Heading ", {scale:0.115, transformOrigin:"49.7% 50.5%"})
        .set("#h8Heading ", {scale:0.26, transformOrigin:"50% 63%"})
        ...
        // -------- F2 IN -------------------------------
        .addLabel("frame2","+=0.5")
        .to("#h1HollowTxtIn .splitted-container:nth-child(1), #h1HollowTxtOut .splitted-container:nth-child(1)", 0.8,{y: -300},"frame2+=0.2")
        .to("#h1HollowTxtIn .splitted-container:nth-child(2), #h1HollowTxtOut .splitted-container:nth-child(2)", 0.8,{y: 300},"frame2+=0.2")
        .to("#h1BigCircMask",0.4,{scale:2, ease:"none"},"frame2+=0.2")
        ...
        .to("#h1Heading .splitted-container:nth-child(2)", 0.4, {scale: 2,y:-20, ease: "none"}, "frame2+=0.3")
        ...
        .from("#h4Heading .splitted-container", 0.4, { y:150, ease: "power4.out"}, "frame5")
            ...
            .to("#heading4 ", 0.5, {scale:13, transformOrigin:"50% 64%", ease:"expo.in"}, "outFrame5")
        ...
        .from("#h5Heading ", 0.4, {scale:0.2, ease:"expo.in", transformOrigin: "50% 60%"}, "frame7-=0.3")
            // -------- F7 OUT --------
            .addLabel("outFrame7")
            .to("#h5Heading", 0.5, {y: "-128px", ease:"expo.out"}, "outFrame7+=1.4")
            
        //-------- F8 IN -------------------------------
        .addLabel("frame8","-=0.5")
        .set("#h5Heading, #h5Heading2, #heading6", {autoAlpha:1}, "frame8")
        ...
        .from("#h5Heading2", 0.5, {y:-70, stagger: 0.1, ease:"expo.out"}, "frame8")
            // -------- F8 OUT --------
            .addLabel("outFrame8")
        ...
        .from("#h8BigCircMask",0.8,{scale:0.043, ease:"power1.inOut"},"frame10")
        ...
        .from(splittedLines[8], 0.3, {y: 100, stagger: 0.1, ease: "power1.out", onStart:()=>{
            gsap.set("#h8Heading .splitted-container", {alpha: 1, stagger: 0.1})
        } }, "frame10+=0.4")
            // -------- F10 OUT --------
            .addLabel("outFrame10")
            .to("#h8HollowTxtIn .splitted-container:nth-child(1), #h8HollowTxtOut .splitted-container:nth-child(1)", 0.8,{y: -300},"outFrame10+=0.45")
            .to("#h8HollowTxtIn .splitted-container:nth-child(2), #h8HollowTxtOut .splitted-container:nth-child(2)", 0.8,{y: 300},"outFrame10+=0.45")
            .to("#h8BigCircMask",0.6,{scale:2, ease:"power4.in"},"outFrame10+=0.2")
        ...
        .to("#BottomLogoA", 0.3,{height:"14px", ease:"power1.inOut"},"frame11+=0.25")

        .to("#ctaArrowOnly", 0.001,{opacity:1, ease:"power1.inOut"},"frame11+=0.1")
        .from("#ctaArrowOnly", 0.15,{x:"-120%", ease:"expo.out"},"frame11+=0.1")
