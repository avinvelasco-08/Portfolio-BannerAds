...
function adjustNonTargetedContent(){
    ...
    Creative.splitLines(["f1Heading","f2Heading","f3Heading","f3Eyebrow","f4Heading","f5Eyebrow","f5Heading","f5SubHead","f6Heading","f7Eyebrow","f7Heading"]);
    Creative.splitChars(["f1Heading","f2Heading","f3Eyebrow","f3Heading","f4Heading","f5Eyebrow","f5Heading","f5SubHead","f6Heading","f7Eyebrow","f7Heading"]);
