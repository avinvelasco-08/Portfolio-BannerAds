...
var Creative = {
    ...
    init: function() {
        // getById("h5Heading2").textContent = h5Heading2;
        ...
        if(h9SubHead === ""){
            Creative.tl.set("#h9SubHead", {display:"none"})
        }
        Creative.splitLines(["h1Heading","h4Heading","","h1HollowTxtOut","h1HollowTxtIn","h5Heading","h5Heading2","h6Heading","h7Heading","h8Heading","h8HollowTxtOut","h8HollowTxtIn","h9Heading"]);
//        alert(bgColor[0])
        ...
        .to("#circRotate, #h5Heading2, #h5Heading .splitted-container:nth-child(1)", {autoAlpha:0}, "reset")
        .set([splittedLines[0], splittedLines[1], splittedWords[0], splittedLines[2], splittedLines[12]], {alpha:0})

        //-------- F1 IN -------------------------------
        .addLabel("frame1",)
        .set("#businessLogo", { display:"flex", xPercent:0, autoAlpha:1 }, "frame1")
        .set("#ctaArrow, #heading1", {autoAlpha:1}, "frame1")
        .set("#main", {backgroundColor: bgColor[0]}, "frame1")
        .set("#h4Heading ", {scale:0.143, transformOrigin:"49.7% 50.5%"})
        .set("#h8Heading ", {scale:0.27, transformOrigin:"50% 63%"})
        
        .from("#h1BigCircMask",1.3,{scale:0.2, ease:"expo.inOut"},"frame1")
        .from("#h1HollowTxtIn, #h1HollowTxtOut",0.001,{opacity:0},"frame1+=0.4")
        // .to("#h1HollowTxtIn .splitted-container:nth-child(2)",0.001,{y: "+=54", ease:"expo:inOut"},"frame1")
        // .to("#h1HollowTxtIn .splitted-container:nth-child(1)",0.001,{y: "-=59", ease:"expo:inOut"},"frame1")
        // .to("#h1HollowTxtOut .splitted-container:nth-child(2)",0.001,{y: "+=35", ease:"expo:inOut"},"frame1")
        // .to("#h1HollowTxtOut .splitted-container:nth-child(1)",0.001,{y: "-=55", ease:"expo:inOut"},"frame1")
        
        .from(splittedLines[0], 0.3, {y: 25, stagger: 0.1, ease: "power1.out", onStart:()=>{
            gsap.set("#h1Heading .splitted-container", {alpha: 1, stagger: 0.1})
        } }, "frame1+=0.7")

        // -------- F2 IN -------------------------------
        .addLabel("frame2","+=0.5")
        .to("#h1HollowTxtIn .splitted-container:nth-child(1)", 0.8,{y: -600},"frame2+=0.2")
        .to("#h1HollowTxtOut .splitted-container:nth-child(1), #h1HollowTxtOut .splitted-container:nth-child(2), #h1HollowTxtOut .splitted-container:nth-child(3)", 0.8,{y: -600},"frame2+=0.2")
        
        .to("#h1HollowTxtIn .splitted-container:nth-child(2)", 0.8,{y: 600},"frame2+=0.2")
        .to("#h1HollowTxtOut .splitted-container:nth-child(4), #h1HollowTxtOut .splitted-container:nth-child(5), #h1HollowTxtOut .splitted-container:nth-child(6)", 0.8,{y: 600},"frame2+=0.2")
        .to("#h1BigCircMask",0.4,{scale:3, ease:"none"},"frame2+=0.2")
        .to("#h1Heading .splitted-container:nth-child(1)", 0.3, {y: -50, ease: "power1.in", onComplete:()=>{
            gsap.to("#h1Heading .splitted-container:nth-child(1)", 0.0001, {opacity: 0})
        }}, "frame2+=0.25")
        .to("#h1Heading .splitted-container:nth-child(2)", 0.4, {scale: 2,y:-24, ease: "none"}, "frame2+=0.3")
        .to("#h1Heading .splitted-container:nth-child(2)", 0.4, {y: -80, ease: "power1.in"}, "frame2+=0.9")

        // -------- F3 IN -------------------------------
        // .addPause()
        .addLabel("frame3", "-=0.15")
        .to("#heading1", {autoAlpha:0}, "frame3+=0.05")
        .set("#main", {backgroundColor: bgColor[1]}, "frame3")
        .from("#h2BigCirc", 0.01, {autoAlpha:0}, "frame3+=0.1")
        .to("#heading2", 0.01, {autoAlpha:1}, "frame3+=0.1")
        .to('#h2Heading', 1.2, {rotate: '180', ease: "power2.inOut", transformOrigin:"50% 50%"}, "frame3+=0.8")
        .from('#h3Heading', 1.2, {rotate: '-180', ease: "power2.inOut", transformOrigin:"50% 60%"}, "frame3+=0.8")
        
        //-------- F4 IN -------------------------------
        .addLabel("frame4", "-=0.55")
        .to('#circRotate', {autoAlpha: 1}, "frame4")
        .to("#heading3", {autoAlpha:1}, "frame4")
        .to("#heading2", {autoAlpha:0}, "frame4")
 
            // -------- F4 OUT --------
            .addLabel("outFrame4","+=0.3")
            .to("#h3Heading", 0.8, {y:-50, ease:"power4.in"}, "outFrame4")

        //-------- F5-F6 IN -------------------------------
        .addLabel("frame5", "-=0.005")
        .to("#heading4", {autoAlpha:1}, "frame5")
        .to("#heading3", {autoAlpha:0}, "frame5")
        .to("#h4Heading .splitted-container", 0.001, {autoAlpha:1}, "frame5")
        .from("#h4Heading .splitted-container", 0.4, { y:150, ease: "power4.out"}, "frame5")
            // -------- F5-F6 OUT --------
            .addLabel("outFrame5", "+=0.21")
            .to("#heading4 ", 0.5, {scale:13, transformOrigin:"50% 55%", ease:"expo.in"}, "outFrame5")
            .to("#heading4 ", 0.001, {opacity:0, ease:"power4.in"}, "outFrame5+=0.5")
            .set("#main", {backgroundColor: "#F3EDE0"}, "outFrame5+=0.5")
        
        //-------- F7 IN -------------------------------
        .addLabel("frame7")
        .to("#heading4, #circSVG", {autoAlpha:0}, "frame7")
        .to("#heading5", {autoAlpha:1}, "frame7")
        .set("#main", {backgroundColor: "#F3EDE0"}, "frame7")
        .from("#h5Heading ", 0.4, {scale:0.2, ease:"expo.in", transformOrigin: "50% 75%"}, "frame7-=0.3")
            // -------- F7 OUT --------
            .addLabel("outFrame7")
            .to("#h5Heading", 0.5, {y: "-194px", ease:"expo.out"}, "outFrame7+=1.4")

        //-------- F8 IN -------------------------------
        .addLabel("frame8","-=0.5")
        .set("#h5Heading, #h5Heading2, #heading6, #h5Heading .splitted-container:nth-child(1)", {autoAlpha:1}, "frame8")
        .from("#h6Heading .splitted-container", 0.001, {autoAlpha: 0, stagger: 0.1}, "frame8+=0.1")
        .from("#h6Heading .splitted-container", 0.6, {y:30, stagger: 0.1, ease:"power4.out"}, "frame8+=0.1")
        .from("#h5Heading2", 0.5, {y:-100, stagger: 0.1, ease:"expo.out"}, "frame8")
        // .from("#h5Heading .splitted-container:nth-child(1)", 0.5, {y:100, stagger: 0.1, ease:"expo.out"}, "frame8")
            // -------- F8 OUT --------
            .addLabel("outFrame8")
            .to("#h6Heading", 0.5, {x:-300, ease:"expo.in"}, "outFrame8")
            .to("#h5Heading, #h5Heading2", 0.65, {x:-300, ease:"expo.in"}, "outFrame8")

        //-------- F9 IN -------------------------------
        .addLabel("frame9")
        .set("#heading7", {autoAlpha:1}, "frame9")
        .from("#h7Heading", 0.5, {x:300, ease:"expo.out"}, "frame9")
            // -------- F9 OUT --------
            .addLabel("outFrame9", "+=0.5")
            .to("#h7Heading", 0.5, {x:300, ease:"expo.in"}, "outFrame9")
            .from("#h7PenLineL, #h7PenCircL", 0.5, {x:-300, ease:"expo.out"}, "outFrame9+=0.28")

        //-------- F10 IN -------------------------------
        .addLabel("frame10", "-=0.01")
        .set("#heading7", {autoAlpha:0}, "frame10")
        .set("#heading8", {autoAlpha:1}, "frame10")
        .set("#main", {backgroundColor: "#F50A23"}, "frame10")
        .from("#h8BigCircMask",0.6,{scale:0.043, ease:"power1.inOut"},"frame10")
        // .to("#h8HollowTxtIn .splitted-container:nth-child(2)",0.001,{y: "+=54", ease:"expo:inOut"},"frame10")
        // .to("#h8HollowTxtIn .splitted-container:nth-child(1)",0.001,{y: "-=59", ease:"expo:inOut"},"frame10")
        // .to("#h8HollowTxtOut .splitted-container:nth-child(2)",0.001,{y: "+=35", ease:"expo:inOut"},"frame10")
        // .to("#h8HollowTxtOut .splitted-container:nth-child(1)",0.001,{y: "-=55", ease:"expo:inOut"},"frame10")
        .to("#h8PenLineL",0.4,{x:-80},"frame10+=0.2")
        .from("#h8Heading", 0.3, {y: 100, stagger: 0.1, ease: "power1.out", onStart:()=>{
            gsap.set("#h8Heading .splitted-container", {alpha: 1, stagger: 0.1})
        } }, "frame10+=0.2")
            // -------- F10 OUT --------
            .addLabel("outFrame10")
            .to("#h8HollowTxtIn .splitted-container:nth-child(1)", 0.8,{y: -600},"outFrame10+=0.45")
            .to("#h8HollowTxtOut .splitted-container:nth-child(1), #h8HollowTxtOut .splitted-container:nth-child(2), #h8HollowTxtOut .splitted-container:nth-child(3)", 0.8,{y: -600},"outFrame10+=0.45")

            .to("#h8HollowTxtIn .splitted-container:nth-child(2)", 0.8,{y: 600},"outFrame10+=0.45")
            .to("#h8HollowTxtOut .splitted-container:nth-child(4), #h8HollowTxtOut .splitted-container:nth-child(5), #h8HollowTxtOut .splitted-container:nth-child(6)", 0.8,{y: 600},"outFrame10+=0.45")
            .to("#h8BigCircMask",0.6,{scale:3, ease:"power4.in"},"outFrame10+=0.2")
            .to("#h8PenLineL",0.6,{x:-250},"outFrame10+=0.5")
            .to("#h8Heading", 0.6, {scale: 1, ease: "power3.in", transformOrigin:"50% 63%", onComplete:()=>{
                gsap.to("#h8Heading", 0.0001, {opacity: 0})
            }}, "outFrame10+=0.2")
        
        //-------- 11 IN -------------------------------
        .addLabel("frame11", "+=0.4")
        .set("#heading8", {autoAlpha:0}, "frame11-=0.7")
        .to("#heading9", {autoAlpha:1}, "frame11-=0.7")
        .from("#h9Heading .splitted-container", 0.5, {y:50, stagger: 0.1, ease: "power4.out"}, "frame11-=0.7")
        .to("#h9Heading .splitted-container", 0.001, {autoAlpha: 1, stagger: 0.1}, "frame11-=0.7")
        .from("#h9SubHead", 0.5, {autoAlpha: 0, ease: "power1.out"}, "frame11-=0.4")

        .to("#businessLogo", 0.01,{autoAlpha:1, ease:"power1.inOut"},"frame11-=0.4")
        .to("#LogoMask1A", 0.5, {right:"0px", ease:"power1.inOut"}, "frame11-=0.4")
        .to("#LogoMask1A", 0.01, {opacity:1, ease:"power1.inOut"}, "frame11-=0.25")
        .to("#BottomLogoA", 0.3,{height:"16px", ease:"power1.inOut"},"frame11+=0.25")

        .to("#ctaArrowOnly", 0.001,{opacity:1, ease:"power1.inOut"},"frame11+=0.1")
        .from("#ctaArrowOnly", 0.15,{x:"-150%", ease:"expo.out"},"frame11+=0.1")

        .to("#main", {backgroundColor: "#F3EDE0"}, "frame11-=0.7")
