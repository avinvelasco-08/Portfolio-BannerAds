...
//        alert(bgColor[0])
        ...
        if(logoToggle[0] === "on"){
            ...
            .to("#BottomLogoA", 0.3,{height:"14px", ease:"power1.inOut"},"frame1+=0.5")
        }
...
//            .from("#h1PenCirc", 0.5, {scale:0.6, ease: "sine.out"}, "frame1+=0.85")
        ...
        //-------- F3 IN -------------------------------
        .addLabel("frame3","-=0.6")
        .to("#heading2", 1.2, {scale:0.56, z:0.001, ease:"expo.in"}, "frame3")
        ...
        .to("#heading2", {autoAlpha:0}, "frame3+=1.1")
            ...
            .to(["#h3Heading","#h3SubHead"], {autoAlpha:0}, "outFrame3+=0.66")
            .to(".f3Circ", 0.4, {scale:2, z:0.001, ease:"power1.out"}, "outFrame3+=0.66")
        ...
        // -------- F7 OUT --------
            ...
            .to("#heading7", 1, {scale:0.56, z:0.001, ease:"expo.in"}, "outFrame7")
        ...
        .to("#heading7", {autoAlpha:0}, "frame8")
            ...
            .to("#h8Heading", 0.8, {y:-200, ease:"power4.in"}, "outFrame8")
        ...
        .to("#LogoMask1A", 0.01, {opacity:1, ease:"power1.inOut"}, "frame9+=0.95")
        .to("#BottomLogoA", 0.3,{height:"14px", ease:"power1.inOut"},"frame9+=1.4")
