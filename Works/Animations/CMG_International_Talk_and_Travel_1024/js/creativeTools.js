...
Creative.positionArrow = function()
{
 ...
 Creative.onThumbDrag = function(event) {
  ...
  Creative.addTooltip = function() 
  {
      ...
      Creative.positionTextBox(bannerData.tooltipEdgeGap);
      
      console.log(bannerData.tooltipEdgeGap);
  ...
  {
      if (isVisible) {
          gsap.set("#arrowTipContainer,#tooltipContainer", { opacity:0, autoAlpha:0 }) // Hide the Tooltip
      } else {
          gsap.set("#arrowTipContainer,#tooltipContainer", { opacity:1, autoAlpha:1 }) // Show the Tooltip
      }
